          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            {excludedRowsCount > 0 && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 bg-amber-950/20 hover:bg-amber-900/30 text-amber-400 border border-amber-900/40 hover:border-amber-700/50 text-xs font-semibold transition-all cursor-pointer shadow-[2px_2px_0_0_#141414] ml-auto md:ml-0"
